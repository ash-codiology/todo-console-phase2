...
const CreateTaskPage: React.FC = () => {
  ...
  // Ensure the token is loaded from localStorage when the component mounts and whenever user changes
  React.useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiService.createTodo(title, description);
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-2xl mx-auto">
            <div className="mb-8">
              <h1 className="text-3xl font-light text-gray-800">Create New Task</h1>
